...
Deep-Learning-Frameworks, welche diese Aufgabe übernehmen.
Das populärste Deep-Learning-Framework (in Bezug auf Verweise in Forschungsarbeiten,
GitHub-Sterne, Verwendung in Firmen usw.) trägt den Namen TensorFlow
\parencite[376]{book:hands-on-ml}.
Es wurde von Google entwickelt und ist seit November 2015
...
\begin{itemize}
  \item Reduzieren der Modellgröße für kürzere Downloadzeiten und
        kleinere RAM Nutzung.
  \item Reduzieren der nötigen Rechenleistung, um eine Prognose durchzuführen,
...
\end{itemize}
Der genaue Ablauf, wie ein Modell in das TensorFlow Lite
spezifische Format umgewandelt wird, wird im nächsten Kapitel
näher untersucht.
...
\input{chapters/einleitung/tikz/compare.tex}
