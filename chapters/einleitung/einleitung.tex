...
Das Attribut \pythoninline{x.shape} gibt die Dimension des Arrays an, die nullte
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\plotw]{einleitung/linear-data.pdf}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\plotw]{einleitung/linear-data-noise.pdf}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\plotw]{einleitung/linear-data-prediction.pdf}
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}
    \node [] {
      \includegraphics[width=\plotw]{einleitung/website.png}
    };
  \end{tikzpicture}
