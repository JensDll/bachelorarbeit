...
jedoch einen Rechenkern, der die
für DL erforderlichen umfangreichen Berechnungen durchführen kann.
In dieser Arbeit wird daher ausschließlich die \pythoninline{tf.keras} API
verwendet. Mit Keras ein Modell zu entwerfen ist unkompliziert:
\begin{pythoncode}
...
\begin{itemize}
  ...
  \item Als nächstes wird eine Eingabeschicht definiert.
        Diese dient ausschließlich dazu, die Dimension der Eingabewerte festzulegen.
        Da das Modell nur eine Zahl entgegen nimmt, ist die Dimension des Eingabevektors eins.
  \item Die nächste Zeile definiert die erste und einzige verborgene Schicht mit
        16 Neuronen. Die Einheiten verwenden die ReLU
