...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\plotw]{first-nn/sine-data.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\plotw]{first-nn/over_underfitting.pdf}
...
Durch erneutes Betrachten der Parameter können die Veränderungen beobachtet werden:
\begin{pyconcode}
...
oder mehr Trainingsdaten gesammelt werden
...
\end{pyconcode}
Sowohl die Werte des $MSE$ als auch die des $MAE$ sind sehr ähnlich
...
Für eine letzte Bestätigung können auch die Vorhersagen
...
\section{Konvertierung des Modells nach TensorFlow Lite}