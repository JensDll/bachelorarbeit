...
geht mithilfe des \pythoninline{edgetpu_compiler}:
\begin{consolecode}
...
> /2.0.1/chapters/first-neural-network/benchmark/download.sh"
$ # Führe das Bash-Skript aus um die Modelle herunterzuladen
$ bash download.sh 2.0.1
$ cd models
$ python sine_benchmark.py
CPU Inferenzgeschwindigkeit: 25.1708 ms
CPU quantisierte Inferenzgeschwindigkeit: 23.7801 ms
TPU Inferenzgeschwindigkeit: 192.0617 ms
\end{consolecode}
...
CPU Inferenzgeschwindigkeit: 2025.5084 ms
TPU Inferenzgeschwindigkeit: 27.6304 ms
\end{consolecode}
